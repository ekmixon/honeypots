...
class QMSSQLServer():
    ...
    def close_port(self):
        return close_port_wrapper('mssql_server', self.ip, self.port, self.logs)

    def kill_server(self):
        return kill_server_wrapper('mssql_server', self.uuid, self.process)
